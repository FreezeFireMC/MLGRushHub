...
import de.chaos.mc.server.mlgrushhub.utils.scorebaord.scoreboards.EnglishScoreboard;
import de.chaos.mc.server.mlgrushhub.utils.scorebaord.scoreboards.FrenchScoreboard;
import de.chaos.mc.server.mlgrushhub.utils.scorebaord.scoreboards.GermanScoreboard;
...
public class ScoreboardManager {
    ...
    public void startUpdater(Plugin plugin) {
        englishScoreboards = new EnglishScoreboard(plugin, playerScorebaordHashMap, statsInterface);
        germanScoreboards = new GermanScoreboard(plugin,  playerScorebaordHashMap, statsInterface);
        frenchScoreboards = new FrenchScoreboard(plugin,  playerScorebaordHashMap, statsInterface);
    }
