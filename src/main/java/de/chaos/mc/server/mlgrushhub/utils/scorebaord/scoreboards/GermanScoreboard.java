...
public class GermanScoreboard {
    ...
    public GermanScoreboard(Plugin plugin, HashMap<UUID, PlayerScorebaord> playerScorebaordHashMap, StatsInterface statsInterface) {
    ...
    public Scoreboard getScorebaord(Player player) {
        ...
        objective.getScore("§cTode: ").setScore(2);
        objective.getScore(ChatColor.AQUA.toString()).setScore(1);
